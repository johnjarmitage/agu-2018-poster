...
{\textsc{ Chiara Civiero, \textbf{John Armitage}, Saskia Goes, James Hammond}  \\ cciviero@cp.dias.ie, armitage@ipgp.fr, saskia.goes@imperial.ac.uk, j.hammond@ucl.ac.uk\vspace{0.3em}} % Author names and institution
...
\begin{center}
\includegraphics[width=0.75\linewidth]{velocities}
...
This work was funded by a Agence Nationale de la Recherche grant to John Armitage and a Janet Watson Fellowship awarded to Chiara Civiero.
} 
...
\begin{minipage}{.48\linewidth}
	\begin{center}
		\includegraphics[width=.4\linewidth]{ms-and-ls}
		\captionof{figure}{Comparison of the observed magnitude of $V_{P}$ below Afar and the MER using a $200\rm\,^{\circ}C$ mid-stage and late stage plume respectively (MS and LS in Figure 4b).}
	\end{center}
\end{minipage}
}
